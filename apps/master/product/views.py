...
class ProductListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['can_add'] = has_permission(self.request.user, 'Product', 'Create')
        context['can_edit'] = has_permission(self.request.user, 'Product', 'Edit')
        context['can_delete'] = has_permission(self.request.user, 'Product', 'Delete')
