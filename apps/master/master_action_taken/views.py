...
class MasterActionTakenListView(ListView):
    ...
    __menu_slug = 'master-action-taken'
    
    @permission_required(__menu_slug,'Browse')
    ...
    def get_context_data(self, **kwargs):
        ...
        context['breadcrumbs'] = [{'name':'Dashboard', 'url':'dashboard'},{'name':'MasterActionTaken', 'url':'master_action_taken_list'}]
...
class MasterActionTakenCreateView(CreateView):
    ...
    __menu_slug = 'master-action-taken'
    @permission_required(__menu_slug ,'Create')
    ...
    def get_context_data(self, **kwargs):
        ...
        context['breadcrumbs'] = [{'name':'Dashboard', 'url':'dashboard'},{'name':'MasterActionTaken', 'url':'master_action_taken_list'},{'name':'Create Master Action Taken', 'url':'master_action_taken_create'}]
        return context
...
class MasterActionTakenUpdateView(UpdateView):
    ...
    @permission_required(__menu_slug ,'Edit')
    def dispatch(self, *args, **kwargs):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['breadcrumbs'] = [{'name':'Dashboard', 'url':'dashboard'},{'name':'MasterActionTaken', 'url':'master_action_taken_list'},{'name':'Update Master Action Taken'}]
        return context
...
class MasterActionTakenDeleteView(DeleteView):
    ...
    @permission_required(__menu_slug ,'Delete')
    def dispatch(self, *args, **kwargs):
        return super().dispatch(*args, **kwargs)
