...
from apps.permission_type.views import PermissionTypeListView, PermissionTypeDetailView, PermissionTypeCreateView, PermissionTypeUpdateView, PermissionTypeDeleteView
urlpatterns = [
