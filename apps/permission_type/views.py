...
class PermissionTypeUpdateView(UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['breadcrumbs'] = [{'name': 'Dashboard', 'url': 'dashboard'}, {'name': 'Permission Types', 'url': 'permission_type_list'}, {'name': 'Update Permission Type'}]
        return context

class PermissionTypeDeleteView(DeleteView):
    model = PermissionType
    template_name = 'permission_type/confirm_delete.html'
    success_url = reverse_lazy('permission_type_list')
